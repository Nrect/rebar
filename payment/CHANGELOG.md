...
- **Документация: `HandleWebhook` отвечает провайдеру классом.** Строка у
  спускового крючка: правило `Translate` потребителя, совпавшее с ошибкой
  хука под `ErrUnavailable`, превратило бы 503 в 4xx. Код не менялся.
