...
//
// Received зовётся ровно один раз на каждый Receive объявленного источника, на
// успехе и на ошибке, с тем исходом, что отдал Receive. Реализация
// потокобезопасна и не паникует: она стоит на пути приёма.
