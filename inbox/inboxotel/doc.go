...
// сверху 15 и 30. Среди них половины таймаутов отправителей — 5 (GitHub и
// Т-Банк ждут 10 с), 7,5 (Standard Webhooks — от 15 с) и 15 (CloudPayments —
// 30 с): на границе порог p99 точен, а не интерполирован. Умолчание SDK
// рассчитано на миллисекунды — весь здоровый приём лёг бы в одну корзину.
//
...
//     заведённые нулём, дают ноль, а не пустоту, и источнику, молчащему с
//     рестарта:
