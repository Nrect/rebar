...
type Store interface {
	...
	// ModifiedAt в ответе — отметка ответа хранилища, а не момент объекта: у
	// s3 это заголовок Date, и с ModifiedAt из List он не совпадает. Сравнивать
	// их нельзя; кому нужен момент объекта, читает List.
