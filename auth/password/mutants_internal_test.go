...
//
// Итог устойчив между прогонами: два выживших и один «не покрытый», все три
// разобраны ниже. Первый прогон давал восемнадцать выживших — все на границах
// валидации, проверенных только со стороны отказа; лечится не разбором, а
// парой тестов «ровно на границе принимается» (config_internal_test.go).
//
