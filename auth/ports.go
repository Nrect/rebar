...
type Identities interface {
	// ByLogin ищет по логину в том виде, в каком его хранит потребитель.
	// Ошибка ErrIdentityNotFound — «нет такой строки», а не сбой: вход
	// отвечает на неё так же, как на неверный пароль.
	...
	// Create заводит личность и возвращает её идентификатор. Занятый логин —
