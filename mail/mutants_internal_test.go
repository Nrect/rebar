...
// выживших на трёх прогонах). Флапают мутанты границ в config.go:46,
// deliver.go:66 и message.go:22 — из-за тестов на реальных часах (таймер
// MinSendGap, SendTimeout, гонка двух сервисов) и per-mutant timeout. С этим
// файлом выживших стабильно три, все ниже.
//
// ЧЕТВЁРТЫЙ ВЫЖИВШИЙ ЖИЛ ЗДЕСЬ НЕЗАМЕЧЕННЫМ: service.go:76, арифметика
...
// три» было утверждением о трёх при четырёх. Убит
