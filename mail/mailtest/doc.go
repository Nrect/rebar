...
// от доменных: ErrIDReused, ErrSendFailed. Сбой хранилища — SetErr,
// SetFinishErr и ErrIDReused — приходит в mail.ErrUnavailable, как у mailpg:
// errors.Is находит и её, и причину (ADR-0007, «Двойники»).
//
// Жители:
//
