module github.com/nrect/rebar/examples/monolith

go 1.26.0

// Пин патч-версии stdlib: тот же, что у остальных модулей репозитория
// (VERSIONING.md, «Единая версия Go»); держит make lockstep.
toolchain go1.26.6

// Пример не получает версий и в теги не входит: он проверяет то, что лежит в
// дереве СЕЙЧАС, а не то, что опубликовано (ADR-0005, «examples/* — модули с
// replace, без версий»).
replace (
	github.com/nrect/rebar/audit => ../../audit
	github.com/nrect/rebar/auth => ../../auth
	github.com/nrect/rebar/authz => ../../authz
	github.com/nrect/rebar/entitlement => ../../entitlement
	github.com/nrect/rebar/kit => ../../kit
	github.com/nrect/rebar/mail => ../../mail
	github.com/nrect/rebar/objectstore => ../../objectstore
	github.com/nrect/rebar/otelboot => ../../otelboot
	github.com/nrect/rebar/outbox => ../../outbox
	github.com/nrect/rebar/payment => ../../payment
	github.com/nrect/rebar/postgres => ../../postgres
	github.com/nrect/rebar/scheduler => ../../scheduler
)

require (
	github.com/google/uuid v1.6.0
	github.com/jackc/pgx/v5 v5.10.0
	github.com/nrect/rebar/audit v0.0.0-20260908221018-051fd21c2237
