...
// ErrHandlerFailed. Сбой хранилища — SetErr, SetFinishErr, отменённый контекст
// и ErrIDReused — приходит в outbox.ErrUnavailable, как у outboxpg: errors.Is
// находит и её, и причину (ADR-0007, «Двойники»).
//
// Жители:
//
